...
/**
 * <strong>Sortierkriterien + Bücherei</strong><br>
...
public class Library extends JFrame {
    ...
    private void generateGUI() {
        ...
        title.addActionListener(e -> {
            books.sort(new BookComparator(Attributes.TITLE));
            outputBooks("Title");
        });
        south.add(title);
        author = new JButton("Author");
        author.addActionListener(e -> {
            books.sort(new BookComparator(Attributes.AUTHOR));
            outputBooks("Author");
        });
        south.add(author);
        year = new JButton("Year");
        year.addActionListener(e -> {
            books.sort(new BookComparator(Attributes.YEAR));
            outputBooks("Year");
        });
        south.add(year);
        publisher = new JButton("Publisher");
        publisher.addActionListener(e -> {
            books.sort(new BookComparator(Attributes.PUBLISHER));
 ...
 * Funktionsweise:
 * Ich übergebe einen Wert des Enums, nach dem Sortiert wird
...
class BookComparator implements Comparator<Book> {
     ...
     * @param attribute Bestimmung, wonach sortiert werden soll
     */
    public BookComparator(Attributes attribute) {
